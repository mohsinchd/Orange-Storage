...
import BusinessUnitCheckbox from "./BusinessUnitCheckbox";
import GeoApiAuto from "../../../GeoApiAuto/GeoApiAuto";
import { toast } from "react-toastify";

const BusinessUnitStorage = () => {
    ...
    <div className="p-3">
      <form onSubmit={submitHandler}>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <label htmlFor="location">
                From Location for Business Storage
              </label>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <label htmlFor="toLocation">
                To Location for Business Storage
              </label>
              <div className="input-group ">
                <span className="input-group-text">
                  <MdLocationCity size={20} />
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="form-group">
              <label htmlFor="size">Select Business Type</label>
              <div className="input-group ">
                <span className="input-group-text">
...
export default BusinessUnitStorage;
